...
class OrangeCrabR0_2Platform(LatticeECP5Platform):
    ...
    resources   = [
        ...
        *SDCardResources(0,
        ...
        Resource("io", 0,
            Subsignal("o5",  Pins("B10", dir="o")),
            Subsignal("o6",  Pins("B9",  dir="o")),
            Subsignal("o9",  Pins("C8",  dir="o")),
            Subsignal("i10", Pins("B8",  dir="i")),
            Subsignal("i11", Pins("A8",  dir="i")),
            Subsignal("i12", Pins("H2",  dir="i")),
            Subsignal("i13", Pins("J2",  dir="i")),
        ),

        Resource("spi", 0,
            Subsignal("sck", Pins("R17", dir="i")),
            Subsignal("mosi",  Pins("N16", dir="i")),
            Subsignal("miso",  Pins("N15",  dir="o")),
            Subsignal("cs0", Pins("N17", dir="i")),
            Subsignal("cs1", Pins("M18", dir="i")),
        ),
    ]
    connectors = [
        Connector("io", 0, {
